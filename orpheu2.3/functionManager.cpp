...
time_t FunctionManager::getTimestamp(char* functionName)
{
...
unsigned short int FunctionManager::addFunction(char* functionName,Function* function,time_t timestamp)
{
...
unsigned short int FunctionManager::getFunctionID(char* functionName)
{
...
long FunctionManager::addHook(AMX* amx,char* functionName,Function* function,OrpheuHookPhase phase)
{
...
void FunctionManager::tryToRemove(char* functionName)
{
	unsigned short int* idPointer = functionNameToFunctionID->retrieve(functionName);
